...
def rcDataObjFsync(*args):
  return _irods.rcDataObjFsync(*args)
rcDataObjFsync = _irods.rcDataObjFsync
...
class MD5_CTX(_object):
    ...
    def set_MD5_CTX_state(self, *args): return _irods.MD5_CTX_set_MD5_CTX_state(self, *args)
    def get_MD5_CTX_state(self, *args): return _irods.MD5_CTX_get_MD5_CTX_state(self, *args)
    def set_MD5_CTX_count(self, *args): return _irods.MD5_CTX_set_MD5_CTX_count(self, *args)
    def get_MD5_CTX_count(self, *args): return _irods.MD5_CTX_get_MD5_CTX_count(self, *args)
    def set_MD5_CTX_buffer(self, *args): return _irods.MD5_CTX_set_MD5_CTX_buffer(self, *args)
    def get_MD5_CTX_buffer(self): return _irods.MD5_CTX_get_MD5_CTX_buffer(self)
    def __init__(self): 
...
RC_COMM = _irods.RC_COMM
RS_COMM = _irods.RS_COMM
...
class queryHandle_t(_object):
    ...
    __del__ = lambda self : None;
    def get_rcComm(self): return _irods.queryHandle_t_get_rcComm(self)
    def __init__(self): 
...
class msParamArray_t(_object):
    ...
    def addIntParam(self, *args): return _irods.msParamArray_t_addIntParam(self, *args)
    def addDoubleParam(self, *args): return _irods.msParamArray_t_addDoubleParam(self, *args)
    def addCharParam(self, *args): return _irods.msParamArray_t_addCharParam(self, *args)
    def __init__(self): 
...
PROCESSING_STATE = _irods.PROCESSING_STATE
RECEIVING_STATE = _irods.RECEIVING_STATE
SENDING_STATE = _irods.SENDING_STATE
CONN_WAIT_STATE = _irods.CONN_WAIT_STATE
FILE_RESTART_OFF = _irods.FILE_RESTART_OFF
FILE_RESTART_ON = _irods.FILE_RESTART_ON
FILE_NOT_RESTART = _irods.FILE_NOT_RESTART
FILE_RESTARTED = _irods.FILE_RESTARTED
class fileRestartInfo_t(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, fileRestartInfo_t, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, fileRestartInfo_t, name)
    __repr__ = _swig_repr
    __swig_setmethods__["fileName"] = _irods.fileRestartInfo_t_fileName_set
    __swig_getmethods__["fileName"] = _irods.fileRestartInfo_t_fileName_get
    if _newclass:fileName = _swig_property(_irods.fileRestartInfo_t_fileName_get, _irods.fileRestartInfo_t_fileName_set)
    __swig_setmethods__["objPath"] = _irods.fileRestartInfo_t_objPath_set
    __swig_getmethods__["objPath"] = _irods.fileRestartInfo_t_objPath_get
    if _newclass:objPath = _swig_property(_irods.fileRestartInfo_t_objPath_get, _irods.fileRestartInfo_t_objPath_set)
    __swig_setmethods__["numSeg"] = _irods.fileRestartInfo_t_numSeg_set
    __swig_getmethods__["numSeg"] = _irods.fileRestartInfo_t_numSeg_get
    if _newclass:numSeg = _swig_property(_irods.fileRestartInfo_t_numSeg_get, _irods.fileRestartInfo_t_numSeg_set)
    __swig_setmethods__["status"] = _irods.fileRestartInfo_t_status_set
    __swig_getmethods__["status"] = _irods.fileRestartInfo_t_status_get
    if _newclass:status = _swig_property(_irods.fileRestartInfo_t_status_get, _irods.fileRestartInfo_t_status_set)
    __swig_setmethods__["fileSize"] = _irods.fileRestartInfo_t_fileSize_set
    __swig_getmethods__["fileSize"] = _irods.fileRestartInfo_t_fileSize_get
    if _newclass:fileSize = _swig_property(_irods.fileRestartInfo_t_fileSize_get, _irods.fileRestartInfo_t_fileSize_set)
    __swig_setmethods__["dataSeg"] = _irods.fileRestartInfo_t_dataSeg_set
    __swig_getmethods__["dataSeg"] = _irods.fileRestartInfo_t_dataSeg_get
    if _newclass:dataSeg = _swig_property(_irods.fileRestartInfo_t_dataSeg_get, _irods.fileRestartInfo_t_dataSeg_set)
    def __init__(self): 
        this = _irods.new_fileRestartInfo_t()
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = _irods.delete_fileRestartInfo_t
    __del__ = lambda self : None;
fileRestartInfo_t_swigregister = _irods.fileRestartInfo_t_swigregister
fileRestartInfo_t_swigregister(fileRestartInfo_t)

class fileRestart_t(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, fileRestart_t, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, fileRestart_t, name)
    __repr__ = _swig_repr
    __swig_setmethods__["flags"] = _irods.fileRestart_t_flags_set
    __swig_getmethods__["flags"] = _irods.fileRestart_t_flags_get
    if _newclass:flags = _swig_property(_irods.fileRestart_t_flags_get, _irods.fileRestart_t_flags_set)
    __swig_setmethods__["writtenSinceUpdated"] = _irods.fileRestart_t_writtenSinceUpdated_set
    __swig_getmethods__["writtenSinceUpdated"] = _irods.fileRestart_t_writtenSinceUpdated_get
    if _newclass:writtenSinceUpdated = _swig_property(_irods.fileRestart_t_writtenSinceUpdated_get, _irods.fileRestart_t_writtenSinceUpdated_set)
    __swig_setmethods__["infoFile"] = _irods.fileRestart_t_infoFile_set
    __swig_getmethods__["infoFile"] = _irods.fileRestart_t_infoFile_get
    if _newclass:infoFile = _swig_property(_irods.fileRestart_t_infoFile_get, _irods.fileRestart_t_infoFile_set)
    __swig_setmethods__["info"] = _irods.fileRestart_t_info_set
    __swig_getmethods__["info"] = _irods.fileRestart_t_info_get
    if _newclass:info = _swig_property(_irods.fileRestart_t_info_get, _irods.fileRestart_t_info_set)
    def __init__(self): 
        this = _irods.new_fileRestart_t()
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = _irods.delete_fileRestart_t
    __del__ = lambda self : None;
fileRestart_t_swigregister = _irods.fileRestart_t_swigregister
fileRestart_t_swigregister(fileRestart_t)
...
NATIVE_PROT = _irods.NATIVE_PROT
XML_PROT = _irods.XML_PROT
...
class transferStat_t(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, transferStat_t, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, transferStat_t, name)
    __repr__ = _swig_repr
    __swig_setmethods__["numThreads"] = _irods.transferStat_t_numThreads_set
    __swig_getmethods__["numThreads"] = _irods.transferStat_t_numThreads_get
    if _newclass:numThreads = _swig_property(_irods.transferStat_t_numThreads_get, _irods.transferStat_t_numThreads_set)
    __swig_setmethods__["flags"] = _irods.transferStat_t_flags_set
    __swig_getmethods__["flags"] = _irods.transferStat_t_flags_get
    if _newclass:flags = _swig_property(_irods.transferStat_t_flags_get, _irods.transferStat_t_flags_set)
    __swig_setmethods__["bytesWritten"] = _irods.transferStat_t_bytesWritten_set
    __swig_getmethods__["bytesWritten"] = _irods.transferStat_t_bytesWritten_get
    if _newclass:bytesWritten = _swig_property(_irods.transferStat_t_bytesWritten_get, _irods.transferStat_t_bytesWritten_set)
    def __init__(self): 
        this = _irods.new_transferStat_t()
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = _irods.delete_transferStat_t
    __del__ = lambda self : None;
transferStat_t_swigregister = _irods.transferStat_t_swigregister
transferStat_t_swigregister(transferStat_t)

class operProgress_t(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, operProgress_t, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, operProgress_t, name)
    __repr__ = _swig_repr
    __swig_setmethods__["oprType"] = _irods.operProgress_t_oprType_set
    __swig_getmethods__["oprType"] = _irods.operProgress_t_oprType_get
    if _newclass:oprType = _swig_property(_irods.operProgress_t_oprType_get, _irods.operProgress_t_oprType_set)
    __swig_setmethods__["flag"] = _irods.operProgress_t_flag_set
    __swig_getmethods__["flag"] = _irods.operProgress_t_flag_get
    if _newclass:flag = _swig_property(_irods.operProgress_t_flag_get, _irods.operProgress_t_flag_set)
    __swig_setmethods__["totalNumFiles"] = _irods.operProgress_t_totalNumFiles_set
    __swig_getmethods__["totalNumFiles"] = _irods.operProgress_t_totalNumFiles_get
    if _newclass:totalNumFiles = _swig_property(_irods.operProgress_t_totalNumFiles_get, _irods.operProgress_t_totalNumFiles_set)
    __swig_setmethods__["totalFileSize"] = _irods.operProgress_t_totalFileSize_set
    __swig_getmethods__["totalFileSize"] = _irods.operProgress_t_totalFileSize_get
    if _newclass:totalFileSize = _swig_property(_irods.operProgress_t_totalFileSize_get, _irods.operProgress_t_totalFileSize_set)
    __swig_setmethods__["totalNumFilesDone"] = _irods.operProgress_t_totalNumFilesDone_set
    __swig_getmethods__["totalNumFilesDone"] = _irods.operProgress_t_totalNumFilesDone_get
    if _newclass:totalNumFilesDone = _swig_property(_irods.operProgress_t_totalNumFilesDone_get, _irods.operProgress_t_totalNumFilesDone_set)
    __swig_setmethods__["totalFileSizeDone"] = _irods.operProgress_t_totalFileSizeDone_set
    __swig_getmethods__["totalFileSizeDone"] = _irods.operProgress_t_totalFileSizeDone_get
    if _newclass:totalFileSizeDone = _swig_property(_irods.operProgress_t_totalFileSizeDone_get, _irods.operProgress_t_totalFileSizeDone_set)
    __swig_setmethods__["curFileName"] = _irods.operProgress_t_curFileName_set
    __swig_getmethods__["curFileName"] = _irods.operProgress_t_curFileName_get
    if _newclass:curFileName = _swig_property(_irods.operProgress_t_curFileName_get, _irods.operProgress_t_curFileName_set)
    __swig_setmethods__["curFileSize"] = _irods.operProgress_t_curFileSize_set
    __swig_getmethods__["curFileSize"] = _irods.operProgress_t_curFileSize_get
    if _newclass:curFileSize = _swig_property(_irods.operProgress_t_curFileSize_get, _irods.operProgress_t_curFileSize_set)
    __swig_setmethods__["curFileSizeDone"] = _irods.operProgress_t_curFileSizeDone_set
    __swig_getmethods__["curFileSizeDone"] = _irods.operProgress_t_curFileSizeDone_get
    if _newclass:curFileSizeDone = _swig_property(_irods.operProgress_t_curFileSizeDone_get, _irods.operProgress_t_curFileSizeDone_set)
    def __init__(self): 
        this = _irods.new_operProgress_t()
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = _irods.delete_operProgress_t
    __del__ = lambda self : None;
operProgress_t_swigregister = _irods.operProgress_t_swigregister
operProgress_t_swigregister(operProgress_t)

UNIX_FILE_TYPE = _irods.UNIX_FILE_TYPE
HPSS_FILE_TYPE = _irods.HPSS_FILE_TYPE
NT_FILE_TYPE = _irods.NT_FILE_TYPE
TEST_STAGE_FILE_TYPE = _irods.TEST_STAGE_FILE_TYPE
S3_FILE_TYPE = _irods.S3_FILE_TYPE
UNIV_MSS_FILE_TYPE = _irods.UNIV_MSS_FILE_TYPE
WOS_FILE_TYPE = _irods.WOS_FILE_TYPE
MSO_FILE_TYPE = _irods.MSO_FILE_TYPE
NON_BLOCKING_FILE_TYPE = _irods.NON_BLOCKING_FILE_TYPE
DIRECT_ACCESS_FILE_TYPE = _irods.DIRECT_ACCESS_FILE_TYPE
OOICI_FILE_TYPE = _irods.OOICI_FILE_TYPE
PYDAP_FILE_TYPE = _irods.PYDAP_FILE_TYPE
ERDDAP_FILE_TYPE = _irods.ERDDAP_FILE_TYPE
TDS_FILE_TYPE = _irods.TDS_FILE_TYPE
HDFS_FILE_TYPE = _irods.HDFS_FILE_TYPE
...
class rError_t(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, rError_t, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, rError_t, name)
    __repr__ = _swig_repr
    __swig_setmethods__["len"] = _irods.rError_t_len_set
    __swig_getmethods__["len"] = _irods.rError_t_len_get
    if _newclass:len = _swig_property(_irods.rError_t_len_get, _irods.rError_t_len_set)
    __swig_setmethods__["errMsg"] = _irods.rError_t_errMsg_set
    __swig_getmethods__["errMsg"] = _irods.rError_t_errMsg_get
    if _newclass:errMsg = _swig_property(_irods.rError_t_errMsg_get, _irods.rError_t_errMsg_set)
    def __init__(self): 
        this = _irods.new_rError_t()
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = _irods.delete_rError_t
    __del__ = lambda self : None;
rError_t_swigregister = _irods.rError_t_swigregister
rError_t_swigregister(rError_t)
...
NO_SPEC_COLL = _irods.NO_SPEC_COLL
STRUCT_FILE_COLL = _irods.STRUCT_FILE_COLL
MOUNTED_COLL = _irods.MOUNTED_COLL
LINKED_COLL = _irods.LINKED_COLL
HAAW_STRUCT_FILE_T = _irods.HAAW_STRUCT_FILE_T
TAR_STRUCT_FILE_T = _irods.TAR_STRUCT_FILE_T
MSSO_STRUCT_FILE_T = _irods.MSSO_STRUCT_FILE_T
...
class keyValPair_t(_object):
    ...
    def getKeyWords(self): return _irods.keyValPair_t_getKeyWords(self)
    def getKeyWord(self, *args): return _irods.keyValPair_t_getKeyWord(self, *args)
    def getValues(self): return _irods.keyValPair_t_getValues(self)
    def getValue(self, *args): return _irods.keyValPair_t_getValue(self, *args)
    def clear(self): return _irods.keyValPair_t_clear(self)
    def add(self, *args): return _irods.keyValPair_t_add(self, *args)
    def getValByKey(self, *args): return _irods.keyValPair_t_getValByKey(self, *args)
...
class inxIvalPair_t(_object):
    ...
    def clear(self): return _irods.inxIvalPair_t_clear(self)
    ...
    def add(self, *args): return _irods.inxIvalPair_t_add(self, *args)
    def getIvalByInx(self, *args): return _irods.inxIvalPair_t_getIvalByInx(self, *args)
...
class inxValPair_t(_object):
    ...
    def clear(self): return _irods.inxValPair_t_clear(self)
    ...
    def add(self, *args): return _irods.inxValPair_t_add(self, *args)
    def getValByInx(self, *args): return _irods.inxValPair_t_getValByInx(self, *args)
...
class rescInfo_t(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, rescInfo_t, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, rescInfo_t, name)
    __repr__ = _swig_repr
    __swig_setmethods__["rescName"] = _irods.rescInfo_t_rescName_set
    __swig_getmethods__["rescName"] = _irods.rescInfo_t_rescName_get
    if _newclass:rescName = _swig_property(_irods.rescInfo_t_rescName_get, _irods.rescInfo_t_rescName_set)
    __swig_setmethods__["rescId"] = _irods.rescInfo_t_rescId_set
    __swig_getmethods__["rescId"] = _irods.rescInfo_t_rescId_get
    if _newclass:rescId = _swig_property(_irods.rescInfo_t_rescId_get, _irods.rescInfo_t_rescId_set)
    __swig_setmethods__["zoneName"] = _irods.rescInfo_t_zoneName_set
    __swig_getmethods__["zoneName"] = _irods.rescInfo_t_zoneName_get
    if _newclass:zoneName = _swig_property(_irods.rescInfo_t_zoneName_get, _irods.rescInfo_t_zoneName_set)
    __swig_setmethods__["rescLoc"] = _irods.rescInfo_t_rescLoc_set
    __swig_getmethods__["rescLoc"] = _irods.rescInfo_t_rescLoc_get
    if _newclass:rescLoc = _swig_property(_irods.rescInfo_t_rescLoc_get, _irods.rescInfo_t_rescLoc_set)
    __swig_setmethods__["rescType"] = _irods.rescInfo_t_rescType_set
    __swig_getmethods__["rescType"] = _irods.rescInfo_t_rescType_get
    if _newclass:rescType = _swig_property(_irods.rescInfo_t_rescType_get, _irods.rescInfo_t_rescType_set)
    __swig_setmethods__["rescTypeInx"] = _irods.rescInfo_t_rescTypeInx_set
    __swig_getmethods__["rescTypeInx"] = _irods.rescInfo_t_rescTypeInx_get
    if _newclass:rescTypeInx = _swig_property(_irods.rescInfo_t_rescTypeInx_get, _irods.rescInfo_t_rescTypeInx_set)
    __swig_setmethods__["rescClassInx"] = _irods.rescInfo_t_rescClassInx_set
    __swig_getmethods__["rescClassInx"] = _irods.rescInfo_t_rescClassInx_get
    if _newclass:rescClassInx = _swig_property(_irods.rescInfo_t_rescClassInx_get, _irods.rescInfo_t_rescClassInx_set)
    __swig_setmethods__["rescStatus"] = _irods.rescInfo_t_rescStatus_set
    __swig_getmethods__["rescStatus"] = _irods.rescInfo_t_rescStatus_get
    if _newclass:rescStatus = _swig_property(_irods.rescInfo_t_rescStatus_get, _irods.rescInfo_t_rescStatus_set)
    __swig_setmethods__["paraOpr"] = _irods.rescInfo_t_paraOpr_set
    __swig_getmethods__["paraOpr"] = _irods.rescInfo_t_paraOpr_get
    if _newclass:paraOpr = _swig_property(_irods.rescInfo_t_paraOpr_get, _irods.rescInfo_t_paraOpr_set)
    __swig_setmethods__["rescClass"] = _irods.rescInfo_t_rescClass_set
    __swig_getmethods__["rescClass"] = _irods.rescInfo_t_rescClass_get
    if _newclass:rescClass = _swig_property(_irods.rescInfo_t_rescClass_get, _irods.rescInfo_t_rescClass_set)
    __swig_setmethods__["rescVaultPath"] = _irods.rescInfo_t_rescVaultPath_set
    __swig_getmethods__["rescVaultPath"] = _irods.rescInfo_t_rescVaultPath_get
    if _newclass:rescVaultPath = _swig_property(_irods.rescInfo_t_rescVaultPath_get, _irods.rescInfo_t_rescVaultPath_set)
    __swig_setmethods__["rescInfo"] = _irods.rescInfo_t_rescInfo_set
    __swig_getmethods__["rescInfo"] = _irods.rescInfo_t_rescInfo_get
    if _newclass:rescInfo = _swig_property(_irods.rescInfo_t_rescInfo_get, _irods.rescInfo_t_rescInfo_set)
    __swig_setmethods__["rescComments"] = _irods.rescInfo_t_rescComments_set
    __swig_getmethods__["rescComments"] = _irods.rescInfo_t_rescComments_get
    if _newclass:rescComments = _swig_property(_irods.rescInfo_t_rescComments_get, _irods.rescInfo_t_rescComments_set)
    __swig_setmethods__["gateWayAddr"] = _irods.rescInfo_t_gateWayAddr_set
    __swig_getmethods__["gateWayAddr"] = _irods.rescInfo_t_gateWayAddr_get
    if _newclass:gateWayAddr = _swig_property(_irods.rescInfo_t_gateWayAddr_get, _irods.rescInfo_t_gateWayAddr_set)
    __swig_setmethods__["rescMaxObjSize"] = _irods.rescInfo_t_rescMaxObjSize_set
    __swig_getmethods__["rescMaxObjSize"] = _irods.rescInfo_t_rescMaxObjSize_get
    if _newclass:rescMaxObjSize = _swig_property(_irods.rescInfo_t_rescMaxObjSize_get, _irods.rescInfo_t_rescMaxObjSize_set)
    __swig_setmethods__["freeSpace"] = _irods.rescInfo_t_freeSpace_set
    __swig_getmethods__["freeSpace"] = _irods.rescInfo_t_freeSpace_get
    if _newclass:freeSpace = _swig_property(_irods.rescInfo_t_freeSpace_get, _irods.rescInfo_t_freeSpace_set)
    __swig_setmethods__["freeSpaceTimeStamp"] = _irods.rescInfo_t_freeSpaceTimeStamp_set
    __swig_getmethods__["freeSpaceTimeStamp"] = _irods.rescInfo_t_freeSpaceTimeStamp_get
    if _newclass:freeSpaceTimeStamp = _swig_property(_irods.rescInfo_t_freeSpaceTimeStamp_get, _irods.rescInfo_t_freeSpaceTimeStamp_set)
    __swig_setmethods__["freeSpaceTime"] = _irods.rescInfo_t_freeSpaceTime_set
    __swig_getmethods__["freeSpaceTime"] = _irods.rescInfo_t_freeSpaceTime_get
    if _newclass:freeSpaceTime = _swig_property(_irods.rescInfo_t_freeSpaceTime_get, _irods.rescInfo_t_freeSpaceTime_set)
    __swig_setmethods__["rescCreate"] = _irods.rescInfo_t_rescCreate_set
    __swig_getmethods__["rescCreate"] = _irods.rescInfo_t_rescCreate_get
    if _newclass:rescCreate = _swig_property(_irods.rescInfo_t_rescCreate_get, _irods.rescInfo_t_rescCreate_set)
    __swig_setmethods__["rescModify"] = _irods.rescInfo_t_rescModify_set
    __swig_getmethods__["rescModify"] = _irods.rescInfo_t_rescModify_get
    if _newclass:rescModify = _swig_property(_irods.rescInfo_t_rescModify_get, _irods.rescInfo_t_rescModify_set)
    __swig_setmethods__["rodsServerHost"] = _irods.rescInfo_t_rodsServerHost_set
    __swig_getmethods__["rodsServerHost"] = _irods.rescInfo_t_rodsServerHost_get
    if _newclass:rodsServerHost = _swig_property(_irods.rescInfo_t_rodsServerHost_get, _irods.rescInfo_t_rodsServerHost_set)
    __swig_setmethods__["quotaLimit"] = _irods.rescInfo_t_quotaLimit_set
    __swig_getmethods__["quotaLimit"] = _irods.rescInfo_t_quotaLimit_get
    if _newclass:quotaLimit = _swig_property(_irods.rescInfo_t_quotaLimit_get, _irods.rescInfo_t_quotaLimit_set)
    __swig_setmethods__["quotaOverrun"] = _irods.rescInfo_t_quotaOverrun_set
    __swig_getmethods__["quotaOverrun"] = _irods.rescInfo_t_quotaOverrun_get
    if _newclass:quotaOverrun = _swig_property(_irods.rescInfo_t_quotaOverrun_get, _irods.rescInfo_t_quotaOverrun_set)
    def __init__(self): 
        this = _irods.new_rescInfo_t()
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = _irods.delete_rescInfo_t
    __del__ = lambda self : None;
rescInfo_t_swigregister = _irods.rescInfo_t_swigregister
rescInfo_t_swigregister(rescInfo_t)
...
class genQueryInp_t(_object):
    ...
    __del__ = lambda self : None;
    def initCondInput(self, *args): return _irods.genQueryInp_t_initCondInput(self, *args)
    def addCondInput(self, *args): return _irods.genQueryInp_t_addCondInput(self, *args)
    def setCondInput(self, *args): return _irods.genQueryInp_t_setCondInput(self, *args)
    def getCondInput(self): return _irods.genQueryInp_t_getCondInput(self)
    def initSelectInp(self, *args): return _irods.genQueryInp_t_initSelectInp(self, *args)
    def addSelectInp(self, *args): return _irods.genQueryInp_t_addSelectInp(self, *args)
    def setSelectInp(self, *args): return _irods.genQueryInp_t_setSelectInp(self, *args)
    def getSelectInp(self): return _irods.genQueryInp_t_getSelectInp(self)
    def initSqlCondInp(self, *args): return _irods.genQueryInp_t_initSqlCondInp(self, *args)
    def addSqlCondInp(self, *args): return _irods.genQueryInp_t_addSqlCondInp(self, *args)
    def setSqlCondInp(self, *args): return _irods.genQueryInp_t_setSqlCondInp(self, *args)
    def getSqlCondInp(self): return _irods.genQueryInp_t_getSqlCondInp(self)
    def __init__(self): 
...
class sendXmsgInfo_t(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, sendXmsgInfo_t, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, sendXmsgInfo_t, name)
    __repr__ = _swig_repr
    __swig_setmethods__["msgNumber"] = _irods.sendXmsgInfo_t_msgNumber_set
    __swig_getmethods__["msgNumber"] = _irods.sendXmsgInfo_t_msgNumber_get
    if _newclass:msgNumber = _swig_property(_irods.sendXmsgInfo_t_msgNumber_get, _irods.sendXmsgInfo_t_msgNumber_set)
    __swig_setmethods__["msgType"] = _irods.sendXmsgInfo_t_msgType_set
    __swig_getmethods__["msgType"] = _irods.sendXmsgInfo_t_msgType_get
    if _newclass:msgType = _swig_property(_irods.sendXmsgInfo_t_msgType_get, _irods.sendXmsgInfo_t_msgType_set)
    __swig_setmethods__["numRcv"] = _irods.sendXmsgInfo_t_numRcv_set
    __swig_getmethods__["numRcv"] = _irods.sendXmsgInfo_t_numRcv_get
    if _newclass:numRcv = _swig_property(_irods.sendXmsgInfo_t_numRcv_get, _irods.sendXmsgInfo_t_numRcv_set)
    __swig_setmethods__["flag"] = _irods.sendXmsgInfo_t_flag_set
    __swig_getmethods__["flag"] = _irods.sendXmsgInfo_t_flag_get
    if _newclass:flag = _swig_property(_irods.sendXmsgInfo_t_flag_get, _irods.sendXmsgInfo_t_flag_set)
    __swig_setmethods__["msg"] = _irods.sendXmsgInfo_t_msg_set
    __swig_getmethods__["msg"] = _irods.sendXmsgInfo_t_msg_get
    if _newclass:msg = _swig_property(_irods.sendXmsgInfo_t_msg_get, _irods.sendXmsgInfo_t_msg_set)
    __swig_setmethods__["numDeli"] = _irods.sendXmsgInfo_t_numDeli_set
    __swig_getmethods__["numDeli"] = _irods.sendXmsgInfo_t_numDeli_get
    if _newclass:numDeli = _swig_property(_irods.sendXmsgInfo_t_numDeli_get, _irods.sendXmsgInfo_t_numDeli_set)
    __swig_setmethods__["miscInfo"] = _irods.sendXmsgInfo_t_miscInfo_set
    __swig_getmethods__["miscInfo"] = _irods.sendXmsgInfo_t_miscInfo_get
    if _newclass:miscInfo = _swig_property(_irods.sendXmsgInfo_t_miscInfo_get, _irods.sendXmsgInfo_t_miscInfo_set)
    __swig_destroy__ = _irods.delete_sendXmsgInfo_t
    __del__ = lambda self : None;
    def __init__(self): 
        this = _irods.new_sendXmsgInfo_t()
        try: self.this.append(this)
        except: self.this = this
sendXmsgInfo_t_swigregister = _irods.sendXmsgInfo_t_swigregister
sendXmsgInfo_t_swigregister(sendXmsgInfo_t)
