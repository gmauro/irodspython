...
class testRodsIO(iRODSTestCase):
    ...
    def test_regReplica_t(self):
        v1 = create_regReplica_t()
        v2 = create_regReplica_t()
        self.assertTrue(test_regReplica_t(v1, v2))

    def test_unregDataObj_t(self):
        v1 = create_unregDataObj_t()
        v2 = create_unregDataObj_t()
        self.assertTrue(test_unregDataObj_t(v1, v2))
